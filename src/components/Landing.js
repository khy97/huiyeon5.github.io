            ...
            <div style={{position:`absolute`, background:`linear-gradient(90deg, rgba(20,136,204,0.9), rgba(43,50,178,0.9))`, width:`100%`, height:`100%`}}>
                <animated.div style={{...props, display:`flex`, flexDirection:`column`, justifyContent:`center`, height:`100%`, position:`relative`}}>
                    <div style={{position:`relative`, display:`flex`, flexDirection:`column`, justifyContent:`center`, height:`100%`}} className="container">
                        <h1 style={{color:`white`, fontFamily:`-apple-system,BlinkMacSystemFont,"Segoe UI",Roboto,"Helvetica Neue",Arial,sans-serif,"Apple Color Emoji","Segoe UI Emoji","Segoe UI Symbol","Noto Color Emoji"`, wordWrap:`normal`}}>Huiyeon Kim; Developer, Tech Enthusiast and a Writer;</h1>
                        <h2 style={{color:`#53dd6c`, fontFamily:`-apple-system,BlinkMacSystemFont,"Segoe UI",Roboto,"Helvetica Neue",Arial,sans-serif,"Apple Color Emoji","Segoe UI Emoji","Segoe UI Symbol","Noto Color Emoji"`, fontWeight:400}}>Focusing on <b>Software Development</b>; Scroll down and get to know me better;</h2>
